...
--
-- Dumping data for table `mtt_lists`
--

LOCK
TABLES `mtt_lists` WRITE;
/*!40000 ALTER TABLE `mtt_lists` DISABLE KEYS */;
INSERT INTO `mtt_lists`
VALUES (1, 'bc430e5d-0e1e-473f-b247-0427039d3fa2', 0, 'Todo', 1504099122, 0, 0, 0, 0);
/*!40000 ALTER TABLE `mtt_lists` ENABLE KEYS */;
UNLOCK
TABLES;
...
--
-- Dumping data for table `mtt_tag2task`
--

LOCK
TABLES `mtt_tag2task` WRITE;
/*!40000 ALTER TABLE `mtt_tag2task` DISABLE KEYS */;
/*!40000 ALTER TABLE `mtt_tag2task` ENABLE KEYS */;
UNLOCK
TABLES;
...
--
-- Dumping data for table `mtt_tags`
--

LOCK
TABLES `mtt_tags` WRITE;
/*!40000 ALTER TABLE `mtt_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `mtt_tags` ENABLE KEYS */;
UNLOCK
TABLES;
...
--
-- Dumping data for table `mtt_todolist`
--

LOCK
TABLES `mtt_todolist` WRITE;
/*!40000 ALTER TABLE `mtt_todolist` DISABLE KEYS */;
/*!40000 ALTER TABLE `mtt_todolist` ENABLE KEYS */;
UNLOCK
TABLES;
...
-- Dump completed on 2017-08-30 15:20:07
